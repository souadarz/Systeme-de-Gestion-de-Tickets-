   ...
   <x-sidebar/>
    ...
    <div class="ml-64 p-8">
        <div class="bg-white rounded-lg shadow">
            ...
            {% endif %}
            <div class="p-6">
                <form action="{{ route('client.createTicket') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="flex justify-end space-x-4">
                        <a href="{{ route('client.clientDashboard') }}" class="px-6 py-2 text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50">
                            Cancel
                        </a>
